...
//      return ReflectUtil.findClass(className);
  ...
  /**
   * Get a list of {@link java.net.URL}s from the context classloader for all the resources found at the
   * specified path.
   *
   * @param path The resource path.
   * @return A list of {@link java.net.URL}s, as returned by {@link ClassLoader#getResources( String )}.
   * @throws java.io.IOException If I/O errors occur
   */
