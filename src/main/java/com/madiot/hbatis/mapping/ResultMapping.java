...
public class ResultMapping {
    ...
    public static class Builder {
        ...
        public Builder(Configuration configuration, String property, ColumnType column, TypeHandler<?> typeHandler) {
            this(configuration, property);
            resultMapping.column = column;
            resultMapping.typeHandler = typeHandler;
        }

        public Builder(Configuration configuration, String property, ColumnType column, Class<?> javaType) {
            this(configuration, property);
            resultMapping.column = column;
        ...
        public Builder column(ColumnType column) {
            resultMapping.column = column;
            return this;
        }
    }
