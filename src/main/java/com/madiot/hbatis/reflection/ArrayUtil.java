...
public class ArrayUtil {
   ...
   * equals() method of {@link java.util.Arrays} returns <code>true</code> (not deepEquals())</li>
   * </ul>
   *
   * @param thisObj
  ...
  /**
   * If the {@code obj} is an array, toString() method of {@link java.util.Arrays} is called. Otherwise
